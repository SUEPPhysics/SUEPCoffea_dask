            ...
            output.update(
                {
                    f"ntracks_{label}": Hist.new.Reg(
                        ...
                        label="$n^{\mathrm{event}}_{\mathrm{tracks}}$",
                    ).Weight(),
    ...
    output.update(
        {
            ...
            .Reg(
                ...
                5,
                name=f"ak4SUEP1_SUEP_BV{label}",
                label="$(p^{\mathrm{jet}}_T - p^{\mathrm{SUEP}}_T)/p^{\mathrm{SUEP}}_T$",
            )
            .Reg(
                300,
                0,
