...
def splitfile(inputs):
    ...
    for m,elist in allpoints.items():
      ...
      output = options.output + m + "/" + fname.split("/")[-1].replace(".root", "_" + m + ".root")
      print()
...
if __name__ == "__main__":
    ...
    parser.add_option("--inputFiles", dest="inputFiles", type="string" , default=None, help="txt file with list of input files (one on each line)")
    ...
    allInputFiles = []
    with open(options.inputFiles, 'r') as filelist:
