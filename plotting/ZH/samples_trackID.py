...
samples = {
  "DY": {
         ...
         "isSig"    : False, 
         "files"    : hdf5inpath("/afs/cern.ch/work/c/cericeci/private/test/SUEPCoffea_dask/output_trackID_DY/") 
  },
  ...
  "ttto2l": {
         ...
         "fillcolor": 2, # Red
         "isSig"    : False,
         "files"    :  hdf5inpath("/afs/cern.ch/work/c/cericeci/private/test/SUEPCoffea_dask/output_trackID_TT/") 
  },
  "ttto1l": {
         ...
         "fillcolor": 5, # Yellow
         "isSig"    : False,
         "files"    : hdf5inpath("/afs/cern.ch/work/c/cericeci/private/test/SUEPCoffea_dask/output_trackID_TT_semilep/")
  },
  ...
  "Wjets": {
         ...
         "fillcolor": 6, # Purple
         "isSig"    : False,
         "files"    : hdf5inpath("/afs/cern.ch/work/c/cericeci/private/test/SUEPCoffea_dask/output_trackID_W/") 
  },
  ...
  "VV": {
         ...
         "fillcolor": 3, # Green
         "isSig"    : False,
         "files"    : hdf5inpath("/afs/cern.ch/work/c/cericeci/private/test/SUEPCoffea_dask/output_trackID_WW/"),
  },
  "ttZ": {
         ...
         "isSig"    : False,
         "files"    : hdf5inpath("/afs/cern.ch/work/c/cericeci/private/test/SUEPCoffea_dask/output_trackID_TTZ_LL/")
  },
  "SUEP_ZH_generic": {
         ...
         "isSig"    : True,
         "files"    : ["/afs/cern.ch/work/c/cericeci/private/test/SUEPCoffea_dask/output_trackID_ZHgeneric//out_1_1_1001.hdf5"],
  },
  ...
  "SUEP_ZH_leptonic": {
         ...
         "isSig"    : True,
         "files"    : ["/afs/cern.ch/work/c/cericeci/private/test/SUEPCoffea_dask/output_trackID_ZHleptonic//out_1_1_1101.hdf5"],
  },
  ...
  "SUEP_ZH_hadronic": {
         ...
         "isSig"    : True,
         "files"    : ["/afs/cern.ch/work/c/cericeci/private/test/SUEPCoffea_dask/output_trackID_ZHhadronic//out_1_1_1001.hdf5"],
  },
