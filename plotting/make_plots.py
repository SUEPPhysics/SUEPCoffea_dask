...
if options.xrootd:
    dataDir = "/scratch/{}/SUEP/{}/{}/merged/".format(
        ...
        output.update(
            {
                ...
                + "ht_tracker_"
                + label: Hist.new.Reg(
                    100, 0, 10000, name=r + "ht_tracker_" + label, label="HT Tracker"
                ).Weight(),
                r
                + "ntracks_"
                + label: Hist.new.Reg(
        ...
        output.update(
            {
                ...
                .Weight(),
                "2D_SUEP_S1_vs_SUEP_pt_mean_scaled_"
                + label: Hist.new.Reg(
                    100, 0, 1, name="SUEP_S1_" + label, label="$Sph_1$"
                )
                .Reg(
                    100,
                    0,
                    1,
                    name="SUEP_pt_mean_scaled_" + label,
                    label="$p_T Avg / p_T Max (Boosted frame)$",
                )
                .Weight(),
                "2D_SUEP_nconst_vs_SUEP_pt_mean_scaled_"
                + label: Hist.new.Reg(
                    200, 0, 500, name="SUEP_nconst_" + label, label="# Const"
                )
                .Reg(
            ...
            output.update(
                {
                    ...
                    + label: Hist.new.Reg(
                        ...
                        0,
                        50,
                        name=r + "SUEP_pt_avg_b_" + label,
                        label=r"SUEP Components $p_T$ avg (Boosted Frame)",
                    ).Weight(),
                    r
                    + "SUEP_pt_mean_scaled_"
                    + label: Hist.new.Reg(
                        100,
                        0,
                        1,
                        name=r + "SUEP_pt_mean_scaled_" + label,
                        label=r"SUEP Components $p_T$ Mean / Max (Boosted Frame)",
                    ).Weight(),
                    r
                    + "SUEP_eta_"
                    + label: Hist.new.Reg(
                    ...
                    r
                    + "SUEP_girth": Hist.new.Reg(
                        50, 0, 1.0, name=r + "SUEP_girth_" + label, label=r"SUEP Girth"
                    ).Weight(),
                    r
                    + "SUEP_rho0_"
                    + label: Hist.new.Reg(
                        50, 0, 20, name=r + "SUEP_rho0_" + label, label=r"SUEP $\rho_0$"
                    ).Weight(),
                    r
                    + "SUEP_rho1_"
                    + label: Hist.new.Reg(
                        50, 0, 20, name=r + "SUEP_rho1_" + label, label=r"SUEP $\rho_1$"
                    ).Weight(),
                }
            )
        ...
        output.update(
            {
                ...
                .Weight(),
                "2D_ISR_S1_vs_ISR_pt_mean_scaled_"
                + label: Hist.new.Reg(100, 0, 1, name="ISR_S1_" + label)
                .Reg(100, 0, 1, name="ISR_pt_mean_scaled_" + label)
                .Weight(),
                "2D_ISR_nconst_vs_ISR_pt_mean_scaled_"
                + label: Hist.new.Reg(200, 0, 500, name="ISR_nconst_" + label)
                .Reg(100, 0, 1, name="ISR_pt_mean_scaled_" + label)
                .Weight(),
            }
            ...
            output.update(
                {
                    ...
                    + label: Hist.new.Reg(
                        ...
                        0,
                        100,
                        name=r + "ISR_pt_avg_b_" + label,
                        label=r"ISR Components $p_T$ avg (Boosted Frame)",
                    ).Weight(),
                    r
                    + "ISR_pt_mean_scaled_"
                    + label: Hist.new.Reg(
                        ...
                        0,
                        1,
                        name=r + "ISR_pt_mean_scaled_" + label,
                        label=r"ISR Components $p_T$ Mean / Max (Boosted Frame)",
                    ).Weight(),
                    r
                    + "ISR_eta_"
                    + label: Hist.new.Reg(
                    ...
                    r
                    + "ISR_girth": Hist.new.Reg(
                        50, 0, 1.0, name=r + "ISR_girth_" + label, label=r"ISR Girth"
                    ).Weight(),
                    r
                    + "ISR_rho0_"
                    + label: Hist.new.Reg(
                        100, 0, 20, name=r + "ISR_rho0_" + label, label=r"ISR $\rho_0$"
                    ).Weight(),
                    r
                    + "ISR_rho1_"
                    + label: Hist.new.Reg(
                        100, 0, 20, name=r + "ISR_rho1_" + label, label=r"ISR $\rho_1$"
                    ).Weight(),
                }
            )
...
if options.isMC:
    if weight > 0.0:
        for plot in list(output.keys()):
            output[plot] = output[plot] * xsection / weight
    else:
        print("Weight is 0")
