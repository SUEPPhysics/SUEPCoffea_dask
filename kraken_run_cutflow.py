...
echo "xrdcp output.coffea root://t3btch065.mit.edu/{outdir}/$3.coffea"
xrdcp output.coffea root://t3btch065.mit.edu/{outdir}/$3.coffea
        ...
        for sample in stream.read().split('\n'):  
            ...
            with open(os.path.join(jobs_dir, "condor.sub"), "w") as condorfile:
                condor = condor_TEMPLATE.format(
                    transfer_file= ",".join([
                        workdir + "/condor_SUEP_cutflow.py",
                        workdir + "/workflows",
                        workdir + "/data",
                        proxy_copy
                    ]),
