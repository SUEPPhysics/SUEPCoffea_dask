...
def ClusterMethod( 
    ...
    SUEP_tracks_b = SUEP_cluster_tracks.boost_p4(boost_SUEP) ### boost the SUEP tracks to their restframe
    ...
    SUEP_genEta_diff_CL = self.out_vars['SUEP_eta_CL' + out_label] - self.out_vars['SUEP_genEta' + out_label]
    SUEP_genPhi_diff_CL = self.out_vars['SUEP_phi_CL' + out_label] - self.out_vars['SUEP_genPhi' + out_label]
